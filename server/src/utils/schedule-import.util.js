...
exports.SCHEDULE_IMPORT_CSV_TEMPLATE = void 0;
exports.parseDayOfWeek = parseDayOfWeek;
exports.parseTimeRange = parseTimeRange;
exports.parseScheduleCsv = parseScheduleCsv;
exports.mapRawRowToImport = mapRawRowToImport;
exports.importSchedulesFromCsv = importSchedulesFromCsv;
const timetable_constraints_util_1 = require("./timetable-constraints.util");
const DAY_MAP = {
    dimanche: 0,
    sunday: 0,
    lundi: 1,
...
function parseTimeRange(combinedOrStart, endOptional) {
...
function mapRawRowToImport(row) {
...
exports.SCHEDULE_IMPORT_CSV_TEMPLATE = `Classe;Jour;Heure début;Heure fin;Matière;Code matière;Salle
6ème A;Lundi;08:00;09:00;Mathématiques;;Salle 101
6ème A;Mardi;10:00;11:00;Français;;Salle 102`;
async function importSchedulesFromCsv(prisma, opts) {
...
async function importSchedulesFromRows(prisma, opts) {
    const result = { created: 0, skipped: 0, errors: [] };
    const skipErrors = opts.skipConstraintErrors !== false;
    const classWhere = opts.schoolId != null && opts.schoolId !== ''
    ...
    const resolveCourse = (classId, name, code) => {
    ...
    for (const item of toCreate) {
        try {
            await (0, timetable_constraints_util_1.assertScheduleConstraints)(prisma, {
...
//# sourceMappingURL=schedule-import.util.js.map