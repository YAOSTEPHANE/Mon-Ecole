...
export const ADM = {
  ...
  tabRow:
    'flex flex-wrap gap-1.5 rounded-2xl bg-gradient-to-b from-stone-100/95 to-stone-50/90 p-1.5 ring-1 ring-stone-200/70 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.85)] backdrop-blur-sm',
  ...
  grid5: 'grid grid-cols-2 lg:grid-cols-5 gap-3.5',
  grid6: 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5',
  statCard:
