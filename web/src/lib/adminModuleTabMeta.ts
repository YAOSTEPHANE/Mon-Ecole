...
const BASE_ADMIN_TABS: AdminModuleTabMeta[] = [
  ...
  { id: 'campus', label: 'Cantine & transport', icon: FiTruck, color: 'from-amber-600 to-orange-700', description: 'Formules repas, lignes de bus et inscriptions' },
  ...
  { id: 'calendar', label: 'Calendrier scolaire', icon: FiCalendar, color: 'from-orange-500 to-orange-600', description: 'Jours fériés, vacances et périodes d’examens' },
  ...
  { id: 'training', label: 'Formation continue', icon: FiTrendingUp, color: 'from-indigo-500 to-violet-600', description: 'Formations des enseignants' },
  ...
  { id: 'certificates', label: 'Certificats & attestations', icon: FiFileText, color: 'from-cptb-blue to-cptb-blue-dark', description: 'Attestations de scolarité, fréquentation et radiation' },
  ...
  { id: 'scholarships', label: 'Bourses & aides', icon: FiGift, color: 'from-cptb-gold to-cptb-gold-dark', description: 'Remises et aides à la scolarité' },
