...
export default function DirectorDashboard() {
  ...
  return (
    <Layout user={user} onLogout={logout} role="ADMIN" hideHeader>
      <PremiumPortalShell variant="director">
        <PortalSpaceHeader
          ...
          trailing={
            <Link
              href="/admin"
              className="hidden sm:inline-flex items-center justify-center gap-2 rounded-xl border border-stone-200 bg-white px-3 py-2 text-xs font-semibold text-stone-800 shadow-sm hover:bg-stone-50"
            >
